...
// TODO: To be deleted
export function ManageUser({ action, details = {} }) {
  ...
  async function onSubmit(values) {
    ...
    try {
      switch (action) {
        case "EDIT":
          ({ data } = await http.put("/v1/users/" + details._id, values));
          handleClose();
          router.refresh();
        ...
        case "DELETE":
          await http.delete("/v1/users/" + details._id);
          handleClose();
          router.refresh();
        ...
        case "ADD":
          ({ data } = await http.post("/v1/user-register", {
            ...values,
          ...
          handleClose();
          router.refresh();
          toast.success("Created the new user successfully");
          return;
      }
    } catch (error) {
      console.log(error);
