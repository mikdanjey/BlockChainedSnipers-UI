...
const Navbar = ({ currentUser }) => {
  ...
  const LogoLightDark = dynamic(() => import("@/components/_App/Logo"), {
    ssr: false,
  });
        ...
        <div className="edemy-nav">
          <div className="container-fluid">
            <div className="navbar navbar-expand-lg navbar-light">
              <Link href="/" className="navbar-brand d-none d-sm-block">
                <LogoLightDark />
              </Link>
              <Link href="/" className="navbar-brand d-block d-sm-none">
                <LogoLightDark />
              </Link>
                  ...
                  {!isStudent && (
                    <>
                      <li className="nav-item">
                        <Link
                          href="/follow-us"
                          className={`nav-link ${pathname === "/follow-us" ? "active" : ""
                            }`}
                        >
                          Follow
                        </Link>
                    ...
                    <>
                      <li className="nav-item">
                        <Link
                          ...
                          className={`nav-link ${pathname === "/learning/dashboard/" ? "active" : ""
                            }`}
                        >
                          Dashboard
                        </Link>
                      ...
                      <li className="nav-item">
                        <Link
                          ...
                          className={`nav-link ${pathname === "/learning/my-courses/" ? "active" : ""
                            }`}
                        >
                          All Courses
                        </Link>
              ...
              <div className="others-option d-flex align-items-center">
                {/* <div className="option-item">
                  <div className="cart-btn">
                    <Link href="/cart">
                      <i className="flaticon-shopping-cart"></i> <span>0</span>
                    </Link>
                  </div>
                </div> */}
