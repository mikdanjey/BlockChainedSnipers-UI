  ...
  return (
    <div className={mainClsAtts}>
      ...
      <div className="shape13" data-speed="0.06" data-revert="true">
        <Image src="/images/shape12.png" width={103} height={103} alt="image" />
      </div>
      <div className="shape14" data-speed="0.06" data-revert="true">
        <Image src="/images/shape13.png" width={220} height={99} alt="image" />
      </div>
      <div className="shape15" data-speed="0.06" data-revert="true">
        <Image src="/images/shape14.png" width={217} height={217} alt="image" />
      </div>
    </div>
  );
};
