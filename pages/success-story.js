          ...
          <div className="row">
            ...
            <div className="col-lg-8 col-md-12">
              <div className="our-story-content">
                <p>
                  <Link href="#">eDdemy.com</Link> began in 2005. After years in
                  the web hosting industry, we realized that it was near
                  impossible for the average Jane or Joe to create their own
                  website. Traditional web hosting services were simply too
            ...
            <div className="col-lg-8 col-md-12">
              <div className="our-story-content">
                <p>
                  We created the <Link href="#">eDdemy.com</Link> Site Builder
                  with the user's perspective in mind. We wanted to offer a
                  platform that would require no coding skills or design
