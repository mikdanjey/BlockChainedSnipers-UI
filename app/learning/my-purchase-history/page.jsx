          ...
          <div className="row justify-content-center">
            <div className="col-lg-9 col-md-12">
              <div className="shopping-cart">
                {enrolments.length > 0 ? (
                  enrolments.map((enrl) => (
                    <div className="shopping-cart-list" key={enrl.id}>
                      <div className="row align-items-center">
                        ...
                        <div className="col-lg-5">
                          <div className="content">
                            ...
                            <ul className="list">
                              <li>{enrl.course.duration}</li>
                              <li>{enrl.course.lessons}</li>
                              <li>{enrl.course.access_time}</li>
                            </ul>
                          </div>
                        </div>
